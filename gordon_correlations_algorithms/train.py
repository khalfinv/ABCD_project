...
if __name__ == "__main__":
	...
	train_dataset = common.CorrelationDataset(os.path.join(args.data_folder,"train_set.pkl"))
		
	validate_dataset = common.CorrelationDataset(os.path.join(args.data_folder,"validate_set.pkl"))
	...
	for epoch in range(num_epochs):
		trainLoss, trainErr = trainFunc(corr_nn, train_loader, criterion, optimizer)
		evaluateLoss, evaluateErr  = evaluateFunc(corr_nn, validate_loader, criterion)
	...
	#Save the Model
	save_checkpoint(corr_nn, os.path.join(args.out_folder, "corr_nn_model.pkl"))
