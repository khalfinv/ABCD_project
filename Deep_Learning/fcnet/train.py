...
if __name__ == "__main__":
	...
	#create object of the FeatureExtractorNet class
	FeatureExtractorNet = common.FeatureExtractor()
	FeatureExtractorNet = common.to_cuda(FeatureExtractorNet)
	# Loss and Optimizer
	criterion = nn.MSELoss()
	optimizer = torch.optim.Adam(FeatureExtractorNet.parameters(),lr = learning_rate)
	trainLossArr = []
	trainErrArr = []
	evaluateLossArr = []
	evaluateErrArr = []
	...
	for epoch in range(num_epochs):
		trainLoss, trainErr = trainFunc(FeatureExtractorNet, train_loader, criterion, optimizer)
		#evaluateLoss, evaluateErr  = evaluateFunc(FeatureExtractorNet, validate_loader, criterion)
	...
	#Save the Model
	# save_checkpoint(FeatureExtractorNet, os.path.join(args.out_folder, "model.pkl"))
